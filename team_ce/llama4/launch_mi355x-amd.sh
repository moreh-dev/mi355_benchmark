...
server_name="ce-bmk-llama4-maverick-${TYPE}-server"
script_name="llama4_maverick_mi355x_docker_${TYPE}.sh"
...
-v ~/mi355_benchmark/team_ce/llama4:/workspace/ -w /workspace/ -e PORT=$PORT \
--entrypoint=/bin/bash \
$IMAGE $script_name
